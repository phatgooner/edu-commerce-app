...
import RelevantTeachers from './RelevantTeachers';

const TeacherModal = ({ show, handleClose, teacher, isFromRelevant }) => {
            ...
            <Modal show={show} onHide={handleClose} centered size="md">
                ...
                <Modal.Body>
                    ...
                    <div className="d-flex flex-column px-2">
                        ...
                        {!isFromRelevant && <Button variant="outline-primary" onClick={() => { handleClose(true); setShowRelevantModal(true); }}>Xem thêm các giáo viên tương tự</Button>}
                    </div>
                </Modal.Body>
